...
function updateLoveTextColor(isAnimated = true) {
  if (!loveTextEl) return;

  loveTextEl.style.color = 'rgba(255, 255, 255, 0.96)';
  loveTextEl.style.textShadow =
...
function createParticleTexture() {
  ...
  for (let i = 0; i <= 220; i++) {
    ...
    const x = centerX + heartX * heartScale;
